...
public class OlxLoginApplication {
	...
	private ApiInfo getApiInfo() {
		...
		ApiInfo apiInfo = new  ApiInfo("OLX-Login REST API Documentation",
				"Zensar has launched professional Rest API for OlX-Login", "3.4", "http://zensar.com/termsofservice",
